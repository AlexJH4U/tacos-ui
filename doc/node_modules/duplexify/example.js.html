...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/duplexify/example.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> duplexify = <span class="hljs-built_in">require</span>(<span class="hljs-string">'duplexify'</span>)
