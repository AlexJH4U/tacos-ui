...
<div class="summary">
<ul>
<li>© 2014 by Philipp Dunkel <a href="mailto:pip@pipobscure.com.html">pip@pipobscure.com</a></li>
...
<span class="hljs-keyword">namespace</span> fse {
  <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">FSEvents</span> :</span> <span class="hljs-keyword">public</span> Nan::ObjectWrap {
  <span class="hljs-keyword">public</span>:
    <span class="hljs-function"><span class="hljs-keyword">explicit</span> <span class="hljs-title">FSEvents</span><span class="hljs-params">(<span class="hljs-keyword">const</span> <span class="hljs-keyword">char</span> *path)</span></span>;
    ~FSEvents();
...
<p>methods.cc - internal</p>
        ...
        <td class="code highlight">
          <pre class="cpp">    Nan::AsyncResource async_resource;
...
FSEvents::FSEvents(<span class="hljs-keyword">const</span> <span class="hljs-keyword">char</span> *path)
   : async_resource(<span class="hljs-string">"fsevents:FSEvents"</span>), lockStarted(<span class="hljs-literal">false</span>) {
