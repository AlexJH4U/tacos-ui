...
<span class="hljs-bullet">    -</span> <span class="hljs-string">NODE_VERSION="v10"</span>
<span class="hljs-bullet">    -</span> <span class="hljs-string">NODE_VERSION="v9"</span>
<span class="hljs-bullet">    -</span> <span class="hljs-string">NODE_VERSION="v8"</span>
...
<span class="hljs-bullet">  -</span> <span class="hljs-string">npm</span> <span class="hljs-string">install</span> <span class="hljs-bullet">-g</span> <span class="hljs-string">npm@3</span>
...
package &amp; publish
        ...
        <td class="code highlight">
          <pre class="yaml">
<span class="hljs-bullet">  -</span> <span class="hljs-string">if</span> <span class="hljs-string">[[</span> <span class="hljs-string">$PUBLISH_BINARY</span> <span class="hljs-string">==</span> <span class="hljs-literal">true</span> <span class="hljs-string">]];</span> <span class="hljs-string">then</span> <span class="hljs-string">npm</span> <span class="hljs-string">run</span> <span class="hljs-string">node-pre-gyp</span> <span class="hljs-string">package</span> <span class="hljs-string">publish;</span> <span class="hljs-string">fi;</span>
...
clean-up
        ...
        <td class="code highlight">
          <pre class="yaml">
<span class="hljs-bullet">  -</span> <span class="hljs-string">npm</span> <span class="hljs-string">run</span> <span class="hljs-string">node-pre-gyp</span> <span class="hljs-string">clean</span>
...
call false so travis will bail at this line.</p>
        ...
        <td class="code highlight">
          <pre class="yaml">
<span class="hljs-bullet">  -</span> <span class="hljs-string">if</span> <span class="hljs-string">[[</span> <span class="hljs-string">$INSTALL_RESULT</span> <span class="hljs-string">!=</span> <span class="hljs-number">0</span> <span class="hljs-string">]];</span> <span class="hljs-string">then</span> <span class="hljs-string">npm</span> <span class="hljs-string">run</span> <span class="hljs-string">node-pre-gyp</span> <span class="hljs-string">unpublish;</span> <span class="hljs-string">fi;</span>
...
<p>display all published binaries</p>
        ...
        <td class="code highlight">
          <pre class="yaml">
<span class="hljs-bullet"> -</span> <span class="hljs-string">npm</span> <span class="hljs-string">run</span> <span class="hljs-string">node-pre-gyp</span> <span class="hljs-string">info</span>
