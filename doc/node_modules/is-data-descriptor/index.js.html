...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/is-data-descriptor/index.js";
...
<div class="summary">
<p>!
is-data-descriptor <a href="https://github.com/jonschlinkert/is-data-descriptor">https://github.com/jonschlinkert/is-data-descriptor</a></p>
</div>
<div class="body">
...
<p>data descriptor properties</p>
  ...
  <span class="hljs-attr">writable</span>: <span class="hljs-string">'boolean'</span>
};

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isDataDescriptor</span>(<span class="hljs-params">obj, prop</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (!(<span class="hljs-string">'value'</span> <span class="hljs-keyword">in</span> obj) &amp;&amp; !(<span class="hljs-string">'writable'</span> <span class="hljs-keyword">in</span> obj)) {
    <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
  }

  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> key <span class="hljs-keyword">in</span> obj) {
    <span class="hljs-keyword">if</span> (key === <span class="hljs-string">'value'</span>) <span class="hljs-keyword">continue</span>;

    <span class="hljs-keyword">if</span> (!data.hasOwnProperty(key)) {
      <span class="hljs-keyword">continue</span>;
    }

    <span class="hljs-keyword">if</span> (typeOf(obj[key]) === data[key]) {
      <span class="hljs-keyword">continue</span>;
    }
...
<div class="dox">
<div class="summary">
<p>Expose <code>isDataDescriptor</code></p>
</div>
<div class="body">
</div>
</div>
...
<span class="hljs-built_in">module</span>.exports = isDataDescriptor;
