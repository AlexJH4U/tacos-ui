...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/hosted-git-info/index.js";
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">protocolToRepresentation</span> (<span class="hljs-params">protocol</span>) </span>{
  <span class="hljs-keyword">if</span> (protocol.substr(<span class="hljs-number">-1</span>) === <span class="hljs-string">':'</span>) protocol = protocol.slice(<span class="hljs-number">0</span>, <span class="hljs-number">-1</span>)
  <span class="hljs-keyword">return</span> protocolToRepresentationMap[protocol] || protocol
}
  ...
  <span class="hljs-keyword">var</span> matches = <span class="hljs-built_in">Object</span>.keys(gitHosts).map(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">gitHostName</span>) </span>{
    <span class="hljs-keyword">try</span> {
      ...
      <span class="hljs-keyword">if</span> (shortcutMatch &amp;&amp; shortcutMatch[<span class="hljs-number">1</span>] === gitHostName) {
        ...
        <span class="hljs-keyword">if</span> (matched[<span class="hljs-number">1</span>] != <span class="hljs-literal">null</span>) user = <span class="hljs-built_in">decodeURIComponent</span>(matched[<span class="hljs-number">1</span>].replace(<span class="hljs-regexp">/^:/</span>, <span class="hljs-string">''</span>))
        <span class="hljs-keyword">if</span> (matched[<span class="hljs-number">2</span>] != <span class="hljs-literal">null</span>) project = <span class="hljs-built_in">decodeURIComponent</span>(matched[<span class="hljs-number">2</span>])
      ...
      <span class="hljs-keyword">if</span> (!(ex <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">URIError</span>)) <span class="hljs-keyword">throw</span> ex
    }
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parseGitUrl</span> (<span class="hljs-params">giturl</span>) </span>{
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> giturl !== <span class="hljs-string">'string'</span>) giturl = <span class="hljs-string">''</span> + giturl
