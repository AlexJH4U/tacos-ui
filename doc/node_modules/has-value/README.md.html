...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/has-value/README.md";
...
<pre><code class="js"><span class="hljs-keyword">var</span> hasValue = <span class="hljs-built_in">require</span>(<span class="hljs-string">'has-value'</span>);
...
<pre><code class="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isEmpty</span>(<span class="hljs-params">o</span>) </span>{
