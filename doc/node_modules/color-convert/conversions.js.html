...
convert.rgb.hsv = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">rgb</span>) </span>{
	<span class="hljs-keyword">var</span> rdif;
	<span class="hljs-keyword">var</span> gdif;
	<span class="hljs-keyword">var</span> bdif;
	<span class="hljs-keyword">var</span> h;
	<span class="hljs-keyword">var</span> s;
	...
	<span class="hljs-keyword">var</span> g = rgb[<span class="hljs-number">1</span>] / <span class="hljs-number">255</span>;
	<span class="hljs-keyword">var</span> b = rgb[<span class="hljs-number">2</span>] / <span class="hljs-number">255</span>;
	<span class="hljs-keyword">var</span> v = <span class="hljs-built_in">Math</span>.max(r, g, b);
	<span class="hljs-keyword">var</span> diff = v - <span class="hljs-built_in">Math</span>.min(r, g, b);
	<span class="hljs-keyword">var</span> diffc = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">c</span>) </span>{
		<span class="hljs-keyword">return</span> (v - c) / <span class="hljs-number">6</span> / diff + <span class="hljs-number">1</span> / <span class="hljs-number">2</span>;
	};
	...
	<span class="hljs-keyword">if</span> (diff === <span class="hljs-number">0</span>) {
		...
		<span class="hljs-keyword">if</span> (r === v) {
			h = bdif - gdif;
		} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (g === v) {
			h = (<span class="hljs-number">1</span> / <span class="hljs-number">3</span>) + rdif - bdif;
		} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (b === v) {
			h = (<span class="hljs-number">2</span> / <span class="hljs-number">3</span>) + gdif - rdif;
		}
		<span class="hljs-keyword">if</span> (h &lt; <span class="hljs-number">0</span>) {
			h += <span class="hljs-number">1</span>;
		} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (h &gt; <span class="hljs-number">1</span>) {
			h -= <span class="hljs-number">1</span>;
		}
	}
