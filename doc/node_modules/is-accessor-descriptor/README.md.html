...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/is-accessor-descriptor/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#is-accessor-descriptor">is-accessor-descriptor  </a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="is-accessor-descriptor">
  <h1>
    <a href="#is-accessor-descriptor" name="is-accessor-descriptor" class="pilcrow"></a>
is-accessor-descriptor <a href="https://www.npmjs.com/package/is-accessor-descriptor"><img src="https://img.shields.io/npm/v/is-accessor-descriptor.svg" alt="NPM version"></a> <a href="https://travis-ci.org/jonschlinkert/is-accessor-descriptor"><img src="https://img.shields.io/travis/jonschlinkert/is-accessor-descriptor.svg" alt="Build Status"></a>
  </h1>
</div>
<blockquote>
...
<pre><code class="js"><span class="hljs-keyword">var</span> isAccessor = <span class="hljs-built_in">require</span>(<span class="hljs-string">'is-accessor-descriptor'</span>);
...
<pre><code class="js">isAccessor(foo, <span class="hljs-string">'bar'</span>);
</code></pre>
...
<pre><code class="js">isAccessor(<span class="hljs-string">'a'</span>)
...
<pre><code class="js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: noop})
...
<pre><code class="js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: noop, <span class="hljs-attr">bar</span>: <span class="hljs-string">'baz'</span>})
...
<pre><code class="js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: <span class="hljs-string">'baz'</span>})
...
<pre><code class="js">isAccessor({<span class="hljs-attr">get</span>: noop, <span class="hljs-attr">set</span>: noop, <span class="hljs-attr">enumerable</span>: <span class="hljs-string">'foo'</span>})
