...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/cache-base/index.js";
...
<span class="hljs-keyword">var</span> get = <span class="hljs-built_in">require</span>(<span class="hljs-string">'get-value'</span>);
<span class="hljs-keyword">var</span> has = <span class="hljs-built_in">require</span>(<span class="hljs-string">'has-value'</span>);
<span class="hljs-keyword">var</span> set = <span class="hljs-built_in">require</span>(<span class="hljs-string">'set-value'</span>);
...
<span class="dox_type">public</span>
  ...
  Cache.prototype.set = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key, val</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (isObject(key) || <span class="hljs-built_in">Array</span>.isArray(key)) {
      ...
      set(prop ? <span class="hljs-keyword">this</span>[prop] : <span class="hljs-keyword">this</span>, key, val);
      <span class="hljs-keyword">this</span>.emit(<span class="hljs-string">'set'</span>, key, val);
    }
...
<span class="dox_type">public</span>
  ...
  Cache.prototype.get = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> ctx = prop ? <span class="hljs-keyword">this</span>[prop] : <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">var</span> val = get(ctx, key);

    <span class="hljs-keyword">this</span>.emit(<span class="hljs-string">'get'</span>, key, val);
...
<span class="dox_type">public</span>
  ...
  Cache.prototype.has = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> has = <span class="hljs-keyword">typeof</span> val !== <span class="hljs-string">'undefined'</span>;
    <span class="hljs-keyword">this</span>.emit(<span class="hljs-string">'has'</span>, key, has);
