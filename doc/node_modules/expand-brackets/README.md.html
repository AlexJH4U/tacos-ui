...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/expand-brackets/README.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#expand-brackets">expand-brackets      </a>
      </div>
      ...
      <div class="heading h3">
        <a href="#options.sourcemap">options.sourcemap</a>
      </div>

      <div class="heading h3">
        <a href="#posix-character-classes">POSIX Character classes</a>
      </div>
...
<pre><code class="js"><span class="hljs-built_in">console</span>.log(brackets(<span class="hljs-string">'[![:lower:]]'</span>));
...
<div class="pilwrap" id="brackets">
  <h3>
    <a href="#brackets" name="brackets" class="pilcrow"></a>
<a href="index.js#L29.html">brackets</a>
  </h3>
</div>
...
<a href="index.js#L54.html">.match</a>
  </h3>
</div>
...
<a href="index.js#L100.html">.isMatch</a>
  </h3>
</div>
...
<a href="index.js#L123.html">.matcher</a>
  </h3>
</div>
...
<a href="index.js#L145.html">.makeRe</a>
  </h3>
</div>
...
<a href="index.js#L187.html">.create</a>
  </h3>
</div>
...
<div class="pilwrap" id="options.sourcemap">
  <h3>
    <a href="#options.sourcemap" name="options.sourcemap" class="pilcrow"></a>
options.sourcemap
  </h3>
</div>
<p>Generate a source map for the given pattern.</p>
<p><strong>Example</strong></p>
<pre><code class="js"><span class="hljs-keyword">var</span> res = brackets(<span class="hljs-string">'[:alpha:]'</span>, {<span class="hljs-attr">sourcemap</span>: <span class="hljs-literal">true</span>});
...
<div class="pilwrap" id="posix-character-classes">
  <h3>
    <a href="#posix-character-classes" name="posix-character-classes" class="pilcrow"></a>
...
<p><em>(This document was generated by <a href="https://github.com/verbose/verb-generate-readme">verb-generate-readme</a> (a <a href="https://github.com/verbose/verb">verb</a> generator), please don't edit the readme directly. Any changes to the readme must be made in <a href=".verb.md.html">.verb.md</a>.)</em></p>
