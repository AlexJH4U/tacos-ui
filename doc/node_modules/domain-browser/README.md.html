...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/domain-browser/README.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#domain-browser">domain-browser</a>
      </div>
...
<div class="pilwrap" id="domain-browser">
  <h1>
    <a href="#domain-browser" name="domain-browser" class="pilcrow"></a>
domain-browser
  </h1>
</div>
<!-- /TITLE -->
<!-- BADGES/ -->
<p><span class="badge-travisci"><a href="http://travis-ci.org/bevry/domain-browser" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/bevry/domain-browser/master.svg" alt="Travis CI Build Status" /></a></span>
...
<br class="badge-separator" />
<span class="badge-slackin"><a href="https://slack.bevry.me" title="Join this project's slack community"><img src="https://slack.bevry.me/badge.svg" alt="Slack community badge" /></a></span></p>
<!-- /BADGES -->
<!-- DESCRIPTION/ -->
