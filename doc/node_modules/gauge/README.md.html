...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/gauge/README.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#changes-from-1.x">CHANGES FROM 1.x</a>
      </div>

      <div class="heading h3">
        <a href="#the-gauge-class">THE GAUGE CLASS</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.show-section-or-status-completed">gauge.show(section | status, [completed])</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.hide-cb">gauge.hide([cb])</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.pulse-subsection">gauge.pulse([subsection])</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#gauge.isenabled">gauge.isEnabled()</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.setthemeset-themes">gauge.setThemeset(themes)</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#themes-opts">themes(opts)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.getdefault-opts">themes.getDefault(opts)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.addtheme-themename-themeobj">themes.addTheme(themeName, themeObj)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.addtheme-themename-parenttheme-newtheme">themes.addTheme(themeName, [parentTheme], newTheme)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.getthemenames">themes.getThemeNames()</a>
      </div>

      <div class="heading h4">
        <a href="#themes.gettheme-name">themes.getTheme(name)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.setdefault-opts-themename">themes.setDefault([opts], themeName)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.newtheme-parenttheme-newtheme">themes.newTheme([parentTheme,] newTheme)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.addtoallthemes-theme">themes.addToAllThemes(theme)</a>
      </div>

      <div class="heading h4">
        <a href="#themes.newthemeset">themes.newThemeset()</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#gauge.settheme-theme-1">gauge.setTheme(theme)</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.settemplate-template-1">gauge.setTemplate(template)</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.setwidth-width">gauge.setWidth(width)</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#gauge.hidecursor">gauge.hideCursor()</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.showcursor">gauge.showCursor()</a>
      </div>

      <div class="heading h4">
        <a href="#gauge.show-status">gauge.show(status)</a>
      </div>
...
<div class="pilwrap" id="changes-from-1.x">
  <h3>
    <a href="#changes-from-1.x" name="changes-from-1.x" class="pilcrow"></a>
CHANGES FROM 1.x
  </h3>
</div>
<p>Gauge 2.x is breaking release, please see the <a href="CHANGELOG.md.html">changelog</a> for details on
what's changed if you were previously a user of this module.</p>
<div class="pilwrap" id="the-gauge-class">
  <h3>
    <a href="#the-gauge-class" name="the-gauge-class" class="pilcrow"></a>
THE GAUGE CLASS
  </h3>
</div>
...
<pre><code>var Gauge = require(&quot;gauge&quot;)
...
<code>resize</code> events on the tty.  (To work around a bug in verisons of Node prior
...
want output (for example, a stream wrapped by the <code>ansi</code> module) then you
need to pass in the <strong>tty</strong> option below, as <code>gauge</code> needs access to
...
<ul>
<li>
<p><strong>updateInterval</strong>: How often gauge updates should be drawn, in miliseconds.</p>
</li>
<li>
<p><strong>fixedFramerate</strong>: Defaults to false on node 0.8, true on everything
else.  When this is true a timer is created to trigger once every
<code>updateInterval</code> ms, when false, updates are printed as soon as they come
in but updates more often than <code>updateInterval</code> are ignored.  The reason
0.8 doesn't have this set to true is that it can't <code>unref</code> its timer and
so it would stop your program from exiting– if you want to use this
feature with 0.8 just make sure you call <code>gauge.disable()</code> before you
expect your program to exit.</p>
</li>
<li>
<p><strong>themes</strong>: A themeset to use when selecting the theme to use. Defaults
to <code>gauge/themes</code>, see the <a href="#themes.html">themes</a> documentation for details.</p>
</li>
<li>
<p><strong>theme</strong>: Select a theme for use, it can be a:</p>
<ul>
...
object.</li>
<li>A configuration object with any of <code>hasUnicode</code>, <code>hasColor</code> or
<code>platform</code> keys, which if wlll be used to override our guesses when making
...
<li>
<p><strong>template</strong>: Describes what you want your gauge to look like.  The
default is what npm uses.  Detailed <a href="#templates.html">documentation</a> is later in this
document.</p>
</li>
<li>
<p><strong>hideCursor</strong>: Defaults to true.  If true, then the cursor will be hidden
while the gauge is displayed.</p>
</li>
<li>
<p><strong>tty</strong>: The tty that you're ultimately writing to.  Defaults to the same
as <strong>stream</strong>.  This is used for detecting the width of the terminal and
resizes. The width used is <code>tty.columns - 1</code>. If no tty is available then
a width of <code>79</code> is assumed.</p>
</li>
<li>
<p><strong>enabled</strong>: Defaults to true if <code>tty</code> is a TTY, false otherwise.  If true
the gauge starts enabled.  If disabled then all update commands are
ignored and no gauge will be printed until you call <code>.enable()</code>.</p>
</li>
<li>
<p><strong>Plumbing</strong>: The class to use to actually generate the gauge for
printing.  This defaults to <code>require('gauge/plumbing')</code> and ordinarly you
shouldn't need to override this.</p>
</li>
<li>
<p><strong>cleanupOnExit</strong>: Defaults to true. Ordinarily we register an exit
...
unexpectedly. You can disable this and it won't register the exit handler.</p>
</li>
</ul>
<div class="pilwrap" id="gauge.show-section-or-status-completed">
  <h4>
    <a href="#gauge.show-section-or-status-completed" name="gauge.show-section-or-status-completed" class="pilcrow"></a>
<code>gauge.show(section | status, [completed])</code>
  </h4>
</div>
...
<code>null</code> and it will be ignored.</p>
...
<div class="pilwrap" id="gauge.hide-cb">
  <h4>
    <a href="#gauge.hide-cb" name="gauge.hide-cb" class="pilcrow"></a>
<code>gauge.hide([cb])</code>
  </h4>
</div>
<p>Removes the gauge from the terminal.  Optionally, callback <code>cb</code> after IO has
had an opportunity to happen (currently this just means after <code>setImmediate</code>
has called back.)</p>
...
<div class="pilwrap" id="gauge.pulse-subsection">
  <h4>
    <a href="#gauge.pulse-subsection" name="gauge.pulse-subsection" class="pilcrow"></a>
<code>gauge.pulse([subsection])</code>
  </h4>
</div>
<ul>
...
included then it will be combined with the last name passed to <code>gauge.show</code>.</p>
...
<div class="pilwrap" id="gauge.isenabled">
  <h4>
    <a href="#gauge.isenabled" name="gauge.isenabled" class="pilcrow"></a>
<code>gauge.isEnabled()</code>
  </h4>
</div>
<p>Returns true if the gauge is enabled.</p>
<div class="pilwrap" id="gauge.setthemeset-themes">
  <h4>
    <a href="#gauge.setthemeset-themes" name="gauge.setthemeset-themes" class="pilcrow"></a>
<code>gauge.setThemeset(themes)</code>
  </h4>
</div>
<p>Change the themeset to select a theme from. The same as the <code>themes</code> option
...
<pre><code>var themes = require('gauge/themes')
...
<p>The object returned by <code>gauge/themes</code> is an instance of the <code>ThemeSet</code> class.</p>
<pre><code>var ThemeSet = require('gauge/theme-set')
var themes = new ThemeSet()
// or
var themes = require('gauge/themes')
var mythemes = themes.newThemeset() // creates a new themeset based on the default themes
</code></pre>
<div class="pilwrap" id="themes-opts">
  <h4>
    <a href="#themes-opts" name="themes-opts" class="pilcrow"></a>
themes(opts)
  </h4>
</div>
<div class="pilwrap" id="themes.getdefault-opts">
  <h4>
    <a href="#themes.getdefault-opts" name="themes.getdefault-opts" class="pilcrow"></a>
...
<li><strong>platform</strong> (optional) - Defaults to <code>process.platform</code>.  If no
platform match is available then <code>fallback</code> is used instead.</li>
</ul>
<p>If no compatible theme can be found then an error will be thrown with a
<code>code</code> of <code>EMISSINGTHEME</code>.</p>
<div class="pilwrap" id="themes.addtheme-themename-themeobj">
  <h4>
    <a href="#themes.addtheme-themename-themeobj" name="themes.addtheme-themename-themeobj" class="pilcrow"></a>
themes.addTheme(themeName, themeObj)
  </h4>
</div>
<div class="pilwrap" id="themes.addtheme-themename-parenttheme-newtheme">
  <h4>
    <a href="#themes.addtheme-themename-parenttheme-newtheme" name="themes.addtheme-themename-parenttheme-newtheme" class="pilcrow"></a>
themes.addTheme(themeName, [parentTheme], newTheme)
  </h4>
</div>
<p>Adds a named theme to the themeset.  You can pass in either a theme object,
as returned by <code>themes.newTheme</code> or the arguments you'd pass to
<code>themes.newTheme</code>.</p>
<div class="pilwrap" id="themes.getthemenames">
  <h4>
    <a href="#themes.getthemenames" name="themes.getthemenames" class="pilcrow"></a>
themes.getThemeNames()
  </h4>
</div>
<p>Return a list of all of the names of the themes in this themeset. Suitable
for use in <code>themes.getTheme(…)</code>.</p>
<div class="pilwrap" id="themes.gettheme-name">
  <h4>
    <a href="#themes.gettheme-name" name="themes.gettheme-name" class="pilcrow"></a>
themes.getTheme(name)
  </h4>
</div>
<p>Returns the theme object from this theme set named <code>name</code>.</p>
<p>If <code>name</code> does not exist in this themeset an error will be thrown with
a <code>code</code> of <code>EMISSINGTHEME</code>.</p>
<div class="pilwrap" id="themes.setdefault-opts-themename">
  <h4>
    <a href="#themes.setdefault-opts-themename" name="themes.setdefault-opts-themename" class="pilcrow"></a>
themes.setDefault([opts], themeName)
  </h4>
</div>
<p><code>opts</code> is an object with the following properties.</p>
<ul>
<li><strong>platform</strong> - Defaults to <code>'fallback'</code>.  If your theme is platform
specific, specify that here with the platform from <code>process.platform</code>, eg,
<code>win32</code>, <code>darwin</code>, etc.</li>
<li><strong>hasUnicode</strong> - Defaults to <code>false</code>. If your theme uses unicode you
should set this to true.</li>
<li><strong>hasColor</strong> - Defaults to <code>false</code>.  If your theme uses color you should
set this to true.</li>
</ul>
<p><code>themeName</code> is the name of the theme (as given to <code>addTheme</code>) to use for
this set of <code>opts</code>.</p>
<div class="pilwrap" id="themes.newtheme-parenttheme-newtheme">
  <h4>
    <a href="#themes.newtheme-parenttheme-newtheme" name="themes.newtheme-parenttheme-newtheme" class="pilcrow"></a>
themes.newTheme([parentTheme,] newTheme)
  </h4>
</div>
<p>Create a new theme object based on <code>parentTheme</code>.  If no <code>parentTheme</code> is
...
fallback parent is defined in <code>gauge/base-theme</code>.)</p>
...
renderer, it's an object with <code>complete</code> and <code>remaining</code> properties
...
<li><strong>preSubsection</strong> - Displayed as a separator between the <code>section</code> and
<code>subsection</code> when the latter is printed.</li>
</ul>
...
<em>values</em> is an object with values provided via <code>gauge.show</code>,
...
<div class="pilwrap" id="themes.addtoallthemes-theme">
  <h4>
    <a href="#themes.addtoallthemes-theme" name="themes.addtoallthemes-theme" class="pilcrow"></a>
themes.addToAllThemes(theme)
  </h4>
</div>
<p>This <em>mixes-in</em> <code>theme</code> into all themes currently defined. It also adds it
to the default parent theme for this themeset, so future themes added to
this themeset will get the values from <code>theme</code> by default.</p>
<div class="pilwrap" id="themes.newthemeset">
  <h4>
    <a href="#themes.newthemeset" name="themes.newthemeset" class="pilcrow"></a>
themes.newThemeset()
  </h4>
</div>
...
<ul>
<li><em>type</em> can be any of the following plus any keys you pass into <code>gauge.show</code> plus
any keys you have on a custom theme.
<ul>
<li><code>section</code> – What big thing you're working on now.</li>
<li><code>subsection</code> – What component of that thing is currently working.</li>
<li><code>activityIndicator</code> – Shows a spinner using the <code>activityIndicatorTheme</code>
from your active theme.</li>
<li><code>progressbar</code> – A progress bar representing your current <code>completed</code>
using the <code>progressbarTheme</code> from your active theme.</li>
</ul>
</li>
...
<div class="pilwrap" id="plumbing">
  <h3>
    <a href="#plumbing" name="plumbing" class="pilcrow"></a>
PLUMBING
  </h3>
</div>
<p>This is the super simple, assume nothing, do no magic internals used by gauge to
implement its ordinary interface.</p>
<pre><code>var Plumbing = require('gauge/plumbing')
...
<div class="pilwrap" id="gauge.settheme-theme-1">
  <h4>
    <a href="#gauge.settheme-theme-1" name="gauge.settheme-theme-1" class="pilcrow"></a>
<code>gauge.setTheme(theme)</code>
  </h4>
</div>
<p>Change the active theme.</p>
<div class="pilwrap" id="gauge.settemplate-template-1">
  <h4>
    <a href="#gauge.settemplate-template-1" name="gauge.settemplate-template-1" class="pilcrow"></a>
<code>gauge.setTemplate(template)</code>
  </h4>
</div>
<p>Change the active template.</p>
<div class="pilwrap" id="gauge.setwidth-width">
  <h4>
    <a href="#gauge.setwidth-width" name="gauge.setwidth-width" class="pilcrow"></a>
<code>gauge.setWidth(width)</code>
  </h4>
</div>
...
<div class="pilwrap" id="gauge.hidecursor">
  <h4>
    <a href="#gauge.hidecursor" name="gauge.hidecursor" class="pilcrow"></a>
<code>gauge.hideCursor()</code>
  </h4>
</div>
<p>Return a string to hide the cursor.</p>
<div class="pilwrap" id="gauge.showcursor">
  <h4>
    <a href="#gauge.showcursor" name="gauge.showcursor" class="pilcrow"></a>
<code>gauge.showCursor()</code>
  </h4>
</div>
<p>Return a string to show the cursor.</p>
<div class="pilwrap" id="gauge.show-status">
  <h4>
    <a href="#gauge.show-status" name="gauge.show-status" class="pilcrow"></a>
<code>gauge.show(status)</code>
  </h4>
</div>
<p>Using <code>status</code> for values, render the provided template with the theme and return
