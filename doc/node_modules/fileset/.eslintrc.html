...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/fileset/.eslintrc";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-attr">"rules"</span>: {
    ...
    <span class="hljs-attr">"no-multi-spaces"</span>: [<span class="hljs-string">"error"</span>, { <span class="hljs-attr">"exceptions"</span>: { <span class="hljs-attr">"VariableDeclarator"</span>: <span class="hljs-literal">true</span> } }],
    <span class="hljs-attr">"promise/param-names"</span>: <span class="hljs-number">0</span>
  }
}
