...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">ECDH</span> (<span class="hljs-params">curve</span>) </span>{
  ...
  <span class="hljs-keyword">this</span>.curve = <span class="hljs-keyword">new</span> elliptic.ec(<span class="hljs-keyword">this</span>.curveType.name) <span class="hljs-comment">// eslint-disable-line new-cap</span>
