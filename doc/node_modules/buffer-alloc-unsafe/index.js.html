...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/buffer-alloc-unsafe/index.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">allocUnsafe</span> (<span class="hljs-params">size</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (Buffer.allocUnsafe) {
    <span class="hljs-keyword">return</span> Buffer.allocUnsafe(size)
  } <span class="hljs-keyword">else</span> {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> Buffer(size)
  }
}

<span class="hljs-built_in">module</span>.exports = allocUnsafe
