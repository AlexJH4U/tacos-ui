...
append-transform <a href="https://travis-ci.org/istanbuljs/append-transform"><img src="https://travis-ci.org/istanbuljs/append-transform.svg?branch=master" alt="Build Status"></a> <a href="https://coveralls.io/github/istanbuljs/append-transform?branch=master"><img src="https://coveralls.io/repos/github/istanbuljs/append-transform/badge.svg?branch=master" alt="Coverage Status"></a>
  </h1>
</div>
<blockquote>
...
<pre><code class="js"><span class="hljs-keyword">const</span> myTransform = <span class="hljs-built_in">require</span>(<span class="hljs-string">'my-transform'</span>);

<span class="hljs-keyword">const</span> oldExtension = <span class="hljs-built_in">require</span>.extensions[<span class="hljs-string">'.js'</span>];

<span class="hljs-built_in">require</span>.extensions[<span class="hljs-string">'.js'</span>] = <span class="hljs-function">(<span class="hljs-params"><span class="hljs-built_in">module</span>, filename</span>) =&gt;</span> {
	<span class="hljs-keyword">const</span> oldCompile = <span class="hljs-built_in">module</span>._compile;

	<span class="hljs-built_in">module</span>._compile = <span class="hljs-function">(<span class="hljs-params">code, filename</span>) =&gt;</span> {
...
<pre><code class="js"><span class="hljs-keyword">const</span> appendTransform = <span class="hljs-built_in">require</span>(<span class="hljs-string">'append-transform'</span>);
<span class="hljs-keyword">const</span> myTransform = <span class="hljs-built_in">require</span>(<span class="hljs-string">'my-transform'</span>);

appendTransform(<span class="hljs-function">(<span class="hljs-params">code, filename</span>) =&gt;</span> {
