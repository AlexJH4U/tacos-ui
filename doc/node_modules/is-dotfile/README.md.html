...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/is-dotfile/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#is-dotfile">is-dotfile    </a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="is-dotfile">
  <h1>
    <a href="#is-dotfile" name="is-dotfile" class="pilcrow"></a>
is-dotfile <a href="https://www.npmjs.com/package/is-dotfile"><img src="https://img.shields.io/npm/v/is-dotfile.svg?style=flat" alt="NPM version"></a> <a href="https://npmjs.org/package/is-dotfile"><img src="https://img.shields.io/npm/dm/is-dotfile.svg?style=flat" alt="NPM monthly downloads"></a> <a href="https://npmjs.org/package/is-dotfile"><img src="https://img.shields.io/npm/dt/is-dotfile.svg?style=flat" alt="NPM total downloads"></a> <a href="https://travis-ci.org/jonschlinkert/is-dotfile"><img src="https://img.shields.io/travis/jonschlinkert/is-dotfile.svg?style=flat&amp;label=Travis" alt="Linux Build Status"></a>
  </h1>
</div>
<blockquote>
...
<pre><code class="sh">$ npm install --save is-dotfile
</code></pre>
...
<p>To be considered a dotfile, it must be the last filename in the path, like <code>.gitignore</code>. Otherwise it's a <a href="https://github.com/jonschlinkert/is-dotdir">dot directory</a>, like <code>.git/</code> and <code>.github/</code>.</p>
<pre><code class="js"><span class="hljs-keyword">var</span> isDotfile = <span class="hljs-built_in">require</span>(<span class="hljs-string">'is-dotfile'</span>);
</code></pre>
<p><strong>false</strong></p>
<p>All of the following return <code>false</code>:</p>
<pre><code class="js">isDotfile(<span class="hljs-string">'a/b/c.js'</span>);
isDotfile(<span class="hljs-string">'/.git/foo'</span>);
isDotfile(<span class="hljs-string">'a/b/c/.git/foo'</span>);
<span class="hljs-comment">//=&gt; false</span>
</code></pre>
<p><strong>true</strong></p>
<p>All of the following return <code>true</code>:</p>
<pre><code class="js">isDotfile(<span class="hljs-string">'a/b/.gitignore'</span>);
isDotfile(<span class="hljs-string">'.gitignore'</span>);
isDotfile(<span class="hljs-string">'/.gitignore'</span>);
...
<ul>
<li><a href="https://www.npmjs.com/package/dotdir-regex">dotdir-regex</a>: Regex for matching dot-directories, like <code>.git/</code> | <a href="https://github.com/regexps/dotdir-regex" title="Regex for matching dot-directories, like `.git/`">homepage</a></li>
<li><a href="https://www.npmjs.com/package/dotfile-regex">dotfile-regex</a>: Regular expresson for matching dotfiles. | <a href="https://github.com/regexps/dotfile-regex" title="Regular expresson for matching dotfiles.">homepage</a></li>
<li><a href="https://www.npmjs.com/package/is-dotdir">is-dotdir</a>: Returns true if a path is a dot-directory. | <a href="https://github.com/jonschlinkert/is-dotdir" title="Returns true if a path is a dot-directory.">homepage</a></li>
...
<tr>
<td>1</td>
<td><a href="https://github.com/Lykathia">Lykathia</a></td>
</tr>
</tbody>
</table>
