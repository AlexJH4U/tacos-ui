...
<span class="hljs-keyword">var</span> keyList = <span class="hljs-built_in">Object</span>.keys;
<span class="hljs-keyword">var</span> hasProp = <span class="hljs-built_in">Object</span>.prototype.hasOwnProperty;
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">equal</span>(<span class="hljs-params">a, b</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> arrA = isArray(a)
    , arrB = isArray(b)
    , i
    , length
    , key;
  ...
  <span class="hljs-keyword">if</span> (a <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Object</span> &amp;&amp; b <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">Object</span>) {
    <span class="hljs-keyword">var</span> keys = keyList(a);
    length = keys.length;

    <span class="hljs-keyword">if</span> (length !== keyList(b).length)
      <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;

    <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; length; i++)
      <span class="hljs-keyword">if</span> (!hasProp.call(b, keys[i])) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
