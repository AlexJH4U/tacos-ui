...
<html>
<head>
  <title>.eslintrc.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../doc-style.css" />
  <script src="../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/hash.js/.eslintrc.js";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-string">'parserOptions'</span>: {
    <span class="hljs-string">'ecmaVersion'</span>: <span class="hljs-number">8</span>
  },
    ...
    <span class="hljs-string">'indent'</span>: [
      ...
      <span class="hljs-number">2</span>,
      {
        <span class="hljs-string">'FunctionDeclaration'</span>: {
          <span class="hljs-string">'parameters'</span>: <span class="hljs-string">'first'</span>
        },
        <span class="hljs-string">'FunctionExpression'</span>: {
          <span class="hljs-string">'parameters'</span>: <span class="hljs-string">'first'</span>
        },
        <span class="hljs-string">'CallExpression'</span>: {
          <span class="hljs-string">'arguments'</span>: <span class="hljs-string">'first'</span>
        }
      }
    ],
