...
<span class="hljs-keyword">var</span> rcodes = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./rcodes'</span>)
<span class="hljs-keyword">var</span> opcodes = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./opcodes'</span>)
...
<span class="hljs-keyword">var</span> name = exports.txt = exports.name = {}

name.encode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str, buf, offset</span>) </span>{
  <span class="hljs-keyword">if</span> (!buf) buf = Buffer.allocUnsafe(name.encodingLength(str))
...
<p>strip leading and trailing .</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> n = str.replace(<span class="hljs-regexp">/^\.|\.$/gm</span>, <span class="hljs-string">''</span>)
  <span class="hljs-keyword">if</span> (n.length) {
...
name.decode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">buf, offset</span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (len === <span class="hljs-number">0</span>) {
    name.decode.bytes = <span class="hljs-number">1</span>
...
header.decode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">buf, offset</span>) </span>{
  ...
  <span class="hljs-keyword">return</span> {
    ...
    <span class="hljs-attr">flag_qr</span>: ((flags &gt;&gt; <span class="hljs-number">15</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">opcode</span>: opcodes.toString((flags &gt;&gt; <span class="hljs-number">11</span>) &amp; <span class="hljs-number">0xf</span>),
    <span class="hljs-attr">flag_auth</span>: ((flags &gt;&gt; <span class="hljs-number">10</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">flag_trunc</span>: ((flags &gt;&gt; <span class="hljs-number">9</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">flag_rd</span>: ((flags &gt;&gt; <span class="hljs-number">8</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">flag_ra</span>: ((flags &gt;&gt; <span class="hljs-number">7</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">flag_z</span>: ((flags &gt;&gt; <span class="hljs-number">6</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">flag_ad</span>: ((flags &gt;&gt; <span class="hljs-number">5</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">flag_cd</span>: ((flags &gt;&gt; <span class="hljs-number">4</span>) &amp; <span class="hljs-number">0x1</span>) === <span class="hljs-number">1</span>,
    <span class="hljs-attr">rcode</span>: rcodes.toString(flags &amp; <span class="hljs-number">0xf</span>),
...
header.encodingLength = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
<span class="hljs-keyword">var</span> rns = exports.ns = {}

rns.encode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data, buf, offset</span>) </span>{
  <span class="hljs-keyword">if</span> (!buf) buf = Buffer.allocUnsafe(rns.encodingLength(data))
  <span class="hljs-keyword">if</span> (!offset) offset = <span class="hljs-number">0</span>

  name.encode(data, buf, offset + <span class="hljs-number">2</span>)
  buf.writeUInt16BE(name.encode.bytes, offset)
  rns.encode.bytes = name.encode.bytes + <span class="hljs-number">2</span>
  <span class="hljs-keyword">return</span> buf
}

rns.encode.bytes = <span class="hljs-number">0</span>

rns.decode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">buf, offset</span>) </span>{
  <span class="hljs-keyword">if</span> (!offset) offset = <span class="hljs-number">0</span>

  <span class="hljs-keyword">var</span> len = buf.readUInt16BE(offset)
  <span class="hljs-keyword">var</span> dd = name.decode(buf, offset + <span class="hljs-number">2</span>)

  rns.decode.bytes = len + <span class="hljs-number">2</span>
  <span class="hljs-keyword">return</span> dd
}

rns.decode.bytes = <span class="hljs-number">0</span>

rns.encodingLength = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data</span>) </span>{
  <span class="hljs-keyword">return</span> name.encodingLength(data) + <span class="hljs-number">2</span>
}

<span class="hljs-keyword">var</span> rsoa = exports.soa = {}

rsoa.encode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data, buf, offset</span>) </span>{
  <span class="hljs-keyword">if</span> (!buf) buf = Buffer.allocUnsafe(rsoa.encodingLength(data))
  <span class="hljs-keyword">if</span> (!offset) offset = <span class="hljs-number">0</span>
  ...
  offset += name.encode.bytes
  buf.writeUInt32BE(data.serial || <span class="hljs-number">0</span>, offset)
  offset += <span class="hljs-number">4</span>
  buf.writeUInt32BE(data.refresh || <span class="hljs-number">0</span>, offset)
  offset += <span class="hljs-number">4</span>
  buf.writeUInt32BE(data.retry || <span class="hljs-number">0</span>, offset)
  offset += <span class="hljs-number">4</span>
  buf.writeUInt32BE(data.expire || <span class="hljs-number">0</span>, offset)
  offset += <span class="hljs-number">4</span>
  buf.writeUInt32BE(data.minimum || <span class="hljs-number">0</span>, offset)
  offset += <span class="hljs-number">4</span>
...
rsoa.encode.bytes = <span class="hljs-number">0</span>

rsoa.decode = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">buf, offset</span>) </span>{
  <span class="hljs-keyword">if</span> (!offset) offset = <span class="hljs-number">0</span>
...
rsoa.decode.bytes = <span class="hljs-number">0</span>

rsoa.encodingLength = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data</span>) </span>{
  <span class="hljs-keyword">return</span> <span class="hljs-number">22</span> + name.encodingLength(data.mname) + name.encodingLength(data.rname)
}
...
ra.encodingLength = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
raaaa.encodingLength = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
<span class="hljs-keyword">var</span> renc = exports.record = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">type</span>) </span>{
  <span class="hljs-keyword">switch</span> (type.toUpperCase()) {
    ...
    <span class="hljs-keyword">case</span> <span class="hljs-string">'NS'</span>: <span class="hljs-keyword">return</span> rns
    <span class="hljs-keyword">case</span> <span class="hljs-string">'SOA'</span>: <span class="hljs-keyword">return</span> rsoa
  }
