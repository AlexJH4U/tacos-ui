...
<span class="dox_type">String</span>
        ...
        <td class="code highlight">
          <pre class="javascript">		get comment() {
			<span class="hljs-keyword">return</span> _comment.toString();
		},
		set comment(val) {
...
<p>data header</p>
        ...
        <td class="code highlight">
          <pre class="javascript">				entry.header.offset = dindex;
				<span class="hljs-keyword">var</span> dataHeader = entry.header.dataHeaderToBinary();
				<span class="hljs-keyword">var</span> c = entry.entryName + entry.extra.toString();
				<span class="hljs-keyword">var</span> postHeader = Buffer.alloc(c.length, c);
...
<p>point to end of data and beginning of central directory first record</p>
        ...
        <td class="code highlight">
          <pre class="javascript">			mainHeader.offset = dindex;
			...
			dindex = <span class="hljs-number">0</span>;
			<span class="hljs-keyword">var</span> outBuffer = Buffer.alloc(totalSize);
...
<p>data header</p>
        ...
        <td class="code highlight">
          <pre class="javascript">						<span class="hljs-keyword">var</span> dataHeader = entry.header.dataHeaderToBinary();
						<span class="hljs-keyword">var</span> postHeader = Buffer.alloc(name);
						<span class="hljs-keyword">var</span> dataLength = dataHeader.length + postHeader.length + compressedData.length;
