...
<span class="hljs-keyword">var</span> fs = Utils.FileSystem.require(),
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-regexp">/*String*/i</span>nput</span>) </span>{
	...
	<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">sanitize</span>(<span class="hljs-params">prefix, name</span>) </span>{
		prefix = pth.resolve(pth.normalize(prefix));
		<span class="hljs-keyword">var</span> parts = name.split(<span class="hljs-string">'/'</span>);
		<span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, l = parts.length; i &lt; l; i++) {
			<span class="hljs-keyword">var</span> path = pth.normalize(pth.join(prefix, parts.slice(i, l).join(pth.sep)));
			<span class="hljs-keyword">if</span> (path.indexOf(prefix) === <span class="hljs-number">0</span>) {
				<span class="hljs-keyword">return</span> path;
			}
		}
		<span class="hljs-keyword">return</span> pth.normalize(pth.join(prefix, pth.basename(name)));
	}
			...
			<span class="hljs-keyword">if</span> (fs.existsSync(localPath)) {
				...
				<span class="hljs-keyword">if</span> (items.length) {
					items.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">path</span>) </span>{
						<span class="hljs-keyword">var</span> p = path.split(<span class="hljs-string">"\\"</span>).join(<span class="hljs-string">"/"</span>).replace(<span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(localPath.replace(<span class="hljs-regexp">/(\(|\))/g</span>, <span class="hljs-string">'\\$1'</span>), <span class="hljs-string">'i'</span>), <span class="hljs-string">""</span>); <span class="hljs-comment">//windows fix</span>
						<span class="hljs-keyword">if</span> (filter(p)) {
							<span class="hljs-keyword">if</span> (p.charAt(p.length - <span class="hljs-number">1</span>) !== <span class="hljs-string">"/"</span>) {
								...
								self.addFile(zipPath + p, Buffer.alloc(<span class="hljs-number">0</span>), <span class="hljs-string">""</span>, <span class="hljs-number">0</span>)
							}
						}
					});
				}
          ...
          <pre class="javascript">		addFile: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-regexp">/*String*/</span>entryName, <span class="hljs-regexp">/*Buffer*/</span>content, <span class="hljs-regexp">/*String*/</span>comment, <span class="hljs-regexp">/*Number*/</span>attr</span>) </span>{
			...
			<span class="hljs-keyword">if</span> (!attr) {
				<span class="hljs-keyword">if</span> (entry.isDirectory) {
					attr = (<span class="hljs-number">0o40755</span> &lt;&lt; <span class="hljs-number">16</span>) | <span class="hljs-number">0x10</span>; <span class="hljs-comment">// (permissions drwxr-xr-x) + (MS-DOS directory flag)</span>
				} <span class="hljs-keyword">else</span> {
					attr = <span class="hljs-number">0o644</span> &lt;&lt; <span class="hljs-number">16</span>; <span class="hljs-comment">// permissions -r-wr--r--</span>
				}
			}
...
<span>Boolean
        ...
        <td class="code highlight">
          <pre class="javascript">		extractEntryTo: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-regexp">/*Object*/</span>entry, <span class="hljs-regexp">/*String*/</span>targetPath, <span class="hljs-regexp">/*Boolean*/m</span>aintainEntryPath, <span class="hljs-regexp">/*Boolean*/</span>overwrite</span>) </span>{
			...
			<span class="hljs-keyword">var</span> entryName = item.entryName;

			<span class="hljs-keyword">var</span> target = sanitize(targetPath, pth.resolve(targetPath, maintainEntryPath ? entryName : pth.basename(entryName)));
			...
			<span class="hljs-keyword">if</span> (item.isDirectory) {
				...
				children.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">child</span>) </span>{
					...
					<span class="hljs-keyword">var</span> childName = sanitize(targetPath, child.entryName);
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">		test: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
			<span class="hljs-keyword">if</span> (!_zip) {
			...
			<span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> entry <span class="hljs-keyword">in</span> _zip.entries) {
				<span class="hljs-keyword">try</span> {
					...
					<span class="hljs-keyword">var</span> content = _zip.entries[entry].getData();
					<span class="hljs-keyword">if</span> (!content) {
						<span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
					}
        ...
        <td class="code highlight">
          <pre class="javascript">		extractAllTo: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-regexp">/*String*/</span>targetPath, <span class="hljs-regexp">/*Boolean*/</span>overwrite</span>) </span>{
			...
			_zip.entries.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">entry</span>) </span>{
				<span class="hljs-keyword">var</span> entryName = sanitize(targetPath, entry.entryName.toString());
				<span class="hljs-keyword">if</span> (entry.isDirectory) {
        ...
        <td class="code highlight">
          <pre class="javascript">		extractAllToAsync: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-regexp">/*String*/</span>targetPath, <span class="hljs-regexp">/*Boolean*/</span>overwrite, <span class="hljs-regexp">/*Function*/</span>callback</span>) </span>{
			...
			entries.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">entry</span>) </span>{
				...
				<span class="hljs-keyword">var</span> entryName = pth.normalize(entry.entryName.toString());
				...
				entry.getDataAsync(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">content</span>) </span>{
					...
					<span class="hljs-keyword">if</span> (!content) {
						...
						callback(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(Utils.Errors.CANT_EXTRACT_FILE));
						<span class="hljs-keyword">return</span>;
					}

					Utils.writeFileToAsync(sanitize(targetPath, entryName), content, overwrite, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">succ</span>) </span>{
