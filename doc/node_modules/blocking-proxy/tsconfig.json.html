...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/blocking-proxy/tsconfig.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-attr">"compilerOptions"</span>: {
    ...
    <span class="hljs-attr">"outDir"</span>: <span class="hljs-string">"built/"</span>
  },
  <span class="hljs-attr">"exclude"</span>: [
    <span class="hljs-string">"built"</span>,
    <span class="hljs-string">"node_modules"</span>,
    <span class="hljs-string">"selenium"</span>,
    <span class="hljs-string">"testapp"</span>,
    <span class="hljs-string">"typings/browser"</span>,
    <span class="hljs-string">"typings/browser.d.ts"</span>
  ],
  <span class="hljs-attr">"filesGlob"</span>: [
