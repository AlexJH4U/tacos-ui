...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#whats-new-in-version-4.2">What&#39;s new in version 4.2</a>
      </div>
      ...
      <div class="heading h2">
        <a href="#how-to-keep-a-css-fragment-intact">How to keep a CSS fragment intact?</a>
      </div>
...
<a href="https://npmcharts.com/compare/clean-css?minimal=true"><img src="https://img.shields.io/npm/dm/clean-css.svg" alt="NPM Downloads"></a>
...
<li><a href="#whats-new-in-version-42.html">What's new in version 4.2</a></li>
...
<li><a href="#how-to-keep-a-css-fragment-intact.html">How to keep a CSS fragment intact?</a></li>
...
<pre><code>npm install --save-dev clean-css
</code></pre>
...
<div class="pilwrap" id="whats-new-in-version-4.2">
  <h2>
    <a href="#whats-new-in-version-4.2" name="whats-new-in-version-4.2" class="pilcrow"></a>
...
<li>allows filtering based on selector in <code>transform</code> callback, see <a href="#how-to-apply-arbitrary-transformations-to-css-properties.html">example</a>;</li>
...
<pre><code class="js"><span class="hljs-keyword">new</span> CleanCSS({
  <span class="hljs-attr">format</span>: {
    ...
    <span class="hljs-attr">breakWith</span>: <span class="hljs-string">'\n'</span>, <span class="hljs-comment">// controls the new line character, can be `'\r\n'` or `'\n'` (aliased as `'windows'` and `'unix'` or `'crlf'` and `'lf'`); defaults to system one, so former on Windows and latter on Unix</span>
    indentBy: <span class="hljs-number">0</span>, <span class="hljs-comment">// controls number of characters to indent with; defaults to `0`</span>
...
<pre><code class="js"><span class="hljs-keyword">new</span> CleanCSS({
  <span class="hljs-attr">level</span>: {
    <span class="hljs-number">1</span>: {
      ...
      semicolonAfterLastProperty: <span class="hljs-literal">false</span>, <span class="hljs-comment">// controls removing trailing semicolons in rule; defaults to `false` - means remove</span>
...
<div class="pilwrap" id="how-to-keep-a-css-fragment-intact">
  <h2>
    <a href="#how-to-keep-a-css-fragment-intact" name="how-to-keep-a-css-fragment-intact" class="pilcrow"></a>
...
<pre><code class="css"><span class="hljs-selector-class">.block-1</span> {
  <span class="hljs-attribute">color</span>: red
}
<span class="hljs-comment">/* clean-css ignore:start */</span>
<span class="hljs-selector-class">.block-special</span> {
  <span class="hljs-attribute">color</span>: transparent
}
<span class="hljs-comment">/* clean-css ignore:end */</span>
<span class="hljs-selector-class">.block-2</span> {
  <span class="hljs-attribute">margin</span>: <span class="hljs-number">0</span>
}
</code></pre>
<p>Optimizing this CSS will result in the following output:</p>
<pre><code class="css"><span class="hljs-selector-class">.block-1</span>{<span class="hljs-attribute">color</span>:red}
<span class="hljs-selector-class">.block-special</span> {
  <span class="hljs-attribute">color</span>: transparent
}
<span class="hljs-selector-class">.block-2</span>{<span class="hljs-attribute">margin</span>:<span class="hljs-number">0</span>}
</code></pre>
