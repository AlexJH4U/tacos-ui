...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/has-values/README.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#has-values">has-values    </a>
      </div>
...
<pre><code class="js"><span class="hljs-keyword">var</span> hasValue = <span class="hljs-built_in">require</span>(<span class="hljs-string">'has-values'</span>);
...
<pre><code class="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">isEmpty</span>(<span class="hljs-params">o, isZero</span>) </span>{
