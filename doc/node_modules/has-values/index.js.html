...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/has-values/index.js";
...
<div class="summary">
<p>!
has-values <a href="https://github.com/jonschlinkert/has-values">https://github.com/jonschlinkert/has-values</a></p>
</div>
<div class="body">
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">hasValue</span>(<span class="hljs-params">val</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>is-number checks for NaN and other edge cases</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (isNumber(val)) {
  ...
  <span class="hljs-keyword">switch</span> (typeOf(val)) {
    ...
    <span class="hljs-keyword">case</span> <span class="hljs-string">'arguments'</span>:
      <span class="hljs-keyword">return</span> val.length !== <span class="hljs-number">0</span>;
    <span class="hljs-keyword">case</span> <span class="hljs-string">'error'</span>:
      <span class="hljs-keyword">return</span> val.message !== <span class="hljs-string">''</span>;
    <span class="hljs-keyword">case</span> <span class="hljs-string">'array'</span>:
      ...
      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; len; i++) {
        <span class="hljs-keyword">if</span> (hasValue(val[i])) {
          <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
        }
      }
      <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
    ...
    <span class="hljs-keyword">case</span> <span class="hljs-string">'set'</span>:
      <span class="hljs-keyword">return</span> val.size !== <span class="hljs-number">0</span>;
    <span class="hljs-keyword">case</span> <span class="hljs-string">'object'</span>:
      ...
      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; keys.length; i++) {
        ...
        <span class="hljs-keyword">if</span> (hasValue(val[key])) {
          <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
        }
      }
      <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
