...
<p>Append the help information</p>
    ...
    <span class="hljs-keyword">return</span> pad(option.flags, width) + <span class="hljs-string">'  '</span> + option.description +
      ((option.bool &amp;&amp; option.defaultValue !== <span class="hljs-literal">undefined</span>) ? <span class="hljs-string">' (default: '</span> + option.defaultValue + <span class="hljs-string">')'</span> : <span class="hljs-string">''</span>);
