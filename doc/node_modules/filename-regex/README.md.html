...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/filename-regex/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#filename-regex">filename-regex     </a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="filename-regex">
  <h1>
    <a href="#filename-regex" name="filename-regex" class="pilcrow"></a>
filename-regex <a href="https://www.npmjs.com/package/filename-regex"><img src="https://img.shields.io/npm/v/filename-regex.svg?style=flat" alt="NPM version"></a> <a href="https://npmjs.org/package/filename-regex"><img src="https://img.shields.io/npm/dm/filename-regex.svg?style=flat" alt="NPM monthly downloads"></a>  <a href="https://npmjs.org/package/filename-regex"><img src="https://img.shields.io/npm/dt/filename-regex.svg?style=flat" alt="NPM total downloads"></a> <a href="https://travis-ci.org/regexhq/filename-regex"><img src="https://img.shields.io/travis/regexhq/filename-regex.svg?style=flat&amp;label=Travis" alt="Linux Build Status"></a>
  </h1>
</div>
<blockquote>
<p>Regular expression for matching file names, with or without extension.</p>
</blockquote>
...
<pre><code class="sh">$ npm install --save filename-regex
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">var</span> regex = <span class="hljs-built_in">require</span>(<span class="hljs-string">'filename-regex'</span>);

<span class="hljs-string">'a/b/c/d.min.js'</span>.match(regex());
<span class="hljs-comment">//=&gt; match[0] = 'd.min.js'</span>

<span class="hljs-string">'a/b/c/.dotfile'</span>.match(regex());
<span class="hljs-comment">//=&gt; match[0] = '.dotfile'</span>
</code></pre>
...
<hr>
<p><em>This file was generated by <a href="https://github.com/verbose/verb-generate-readme">verb-generate-readme</a>, v0.4.3, on April 28, 2017.</em></p>
</div>
  </div>
</body>
</html>
