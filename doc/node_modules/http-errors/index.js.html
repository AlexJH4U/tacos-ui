...
<p>backwards-compatibility</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  exports[<span class="hljs-string">"I'mateapot"</span>] = deprecate.function(exports.ImATeapot,
    <span class="hljs-string">'"I\'mateapot"; use "ImATeapot" instead'</span>)
}
