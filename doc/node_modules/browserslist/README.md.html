...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#shareable-configs">Shareable Configs</a>
      </div>
...
Browserslist <a href="http://cultofmartians.com/done.html"><img src="http://cultofmartians.com/assets/badges/badge.svg" alt="Cult Of Martians"></a>
  </h1>
</div>
<p><img align="right" width="120" height="120"
     src="./logo.svg" alt="Browserslist logo by Anton Lovchikov"></p>
...
<li><a href="https://github.com/babel/babel/tree/master/packages/babel-preset-env">Babel</a>
(external config in <code>package.json</code> or <code>browserslist</code> will be supported in 7.0)</li>
...
<div class="pilwrap" id="tools">
  <h2>
    <a href="#tools" name="tools" class="pilcrow"></a>
Tools
  </h2>
</div>
<ul>
...
<li><a href="https://github.com/pastelsky/browserslist-useragent"><code>browserslist-useragent</code></a> checks browser by user agent string
...
<div class="pilwrap" id="best-practices">
  <h3>
    <a href="#best-practices" name="best-practices" class="pilcrow"></a>
Best Practices
  </h3>
</div>
<ul>
<li>Select browsers directly (<code>last 2 Chrome versions</code>) only if you are making
web app for kiosk with one browser. There are a lot browsers on the market.
If you are making general web app you should respect browsers diversity.</li>
<li>If you want to change the default set of browsers we recommend to combine
<code>last 1 version</code>, <code>not dead</code> with <code>&gt; 0.2%</code> (or <code>&gt; 1% in US</code>,
<code>&gt; 1% in my stats</code>). Just <code>last n versions</code> adds to many dead browsers
and do not add popular old versions. Just <code>&gt; 0.2%</code> make popular browsers even
more popular, so we will have a monopoly and stagnation, as we had
with Internet Explorer 6.</li>
<li>Don’t remove browsers just because you don’t know them. Opera Mini has
100 million users in Africa and it is more popular in global market,
than Microsoft Edge. Chinese QQ Browsers has more market share than Firefox
and desktop Safari altogether.</li>
</ul>
<div class="pilwrap" id="full-list">
  <h3>
    <a href="#full-list" name="full-list" class="pilcrow"></a>
Full List
  </h3>
</div>
...
<li><code>cover 99.5% in US</code>: same as above, with <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements">two-letter country code</a>.</li>
<li><code>cover 99.5% in my stats</code>: uses <a href="#custom-usage-data.html">custom usage data</a>.</li>
...
by your queries.</p>
<pre><code class="sh">$ npx browserslist
and_chr 61
and_ff 56
and_qq 1.2
and_uc 11.4
...
<div class="pilwrap" id="shareable-configs">
  <h2>
    <a href="#shareable-configs" name="shareable-configs" class="pilcrow"></a>
Shareable Configs
  </h2>
</div>
...
<pre><code class="js">browserslist(queries, { path, <span class="hljs-attr">dangerousExtend</span>: <span class="hljs-literal">true</span> })
</code></pre>
...
<pre><code class="js">  <span class="hljs-string">"browserslist"</span>: {
...
<pre><code class="ini">[production staging]
&gt; 1%
ie 10
...
<pre><code class="sh">browserslist <span class="hljs-string">"&gt; 1%, IE 10"</span>
</code></pre>
...
<pre><code class="js">browserslist.coverage(browserslist(<span class="hljs-string">'&gt; 1%'</span>))
<span class="hljs-comment">//=&gt; 81.4</span>
</code></pre>
<pre><code class="js">browserslist.coverage(browserslist(<span class="hljs-string">'&gt; 1% in US'</span>), <span class="hljs-string">'US'</span>)
<span class="hljs-comment">//=&gt; 83.1</span>
</code></pre>
<pre><code class="js">browserslist.coverage(browserslist(<span class="hljs-string">'&gt; 1% in my stats'</span>), <span class="hljs-string">'my stats'</span>)
<span class="hljs-comment">//=&gt; 83.1</span>
</code></pre>
<pre><code class="js">browserslist.coverage(browserslist(<span class="hljs-string">'&gt; 1% in my stats'</span>, { stats }), stats)
...
<pre><code class="sh">$ browserslist --coverage <span class="hljs-string">"&gt; 1% in my stats"</span>
...
<pre><code class="sh">$ browserslist --coverage <span class="hljs-string">"&gt; 1% in my stats"</span> --stats=./stats.json
These browsers account <span class="hljs-keyword">for</span> 83.1% of all users <span class="hljs-keyword">in</span> custom statistics
</code></pre>
