...
<span class="hljs-keyword">var</span> ast = acorn.parse(<span class="hljs-string">'var x = 42; // answer'</span>, {
	...
	ranges: <span class="hljs-literal">true</span>,
...
<span class="hljs-keyword">const</span> walk = <span class="hljs-built_in">require</span>(<span class="hljs-string">"acorn/dist/walk"</span>)
...
walk.ancestor(acorn.parse(<span class="hljs-string">"foo('hi')"</span>), {
  Literal(_, ancestors) {
    <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"This literal's ancestors are:"</span>,
                ancestors.map(<span class="hljs-function"><span class="hljs-params">n</span> =&gt;</span> n.type))
  }
})
</code></pre>
...
<ul>
<li><a href="https://github.com/acornjs/acorn-stage3"><code>acorn-stage3</code></a>: Parse most stage 3 proposals, bundling:
<ul>
