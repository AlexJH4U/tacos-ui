...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/engine.io-client/engine.io.js";
...
<span class="dox_type">public</span>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-built_in">module</span>.exports.parser = __webpack_require__(<span class="hljs-number">9</span>);
...
<div class="body">
	...
	<span class="hljs-keyword">var</span> transports = __webpack_require__(<span class="hljs-number">3</span>);
	<span class="hljs-keyword">var</span> Emitter = __webpack_require__(<span class="hljs-number">19</span>);
	<span class="hljs-keyword">var</span> debug = __webpack_require__(<span class="hljs-number">23</span>)(<span class="hljs-string">'engine.io-client:socket'</span>);
	<span class="hljs-keyword">var</span> index = __webpack_require__(<span class="hljs-number">30</span>);
	<span class="hljs-keyword">var</span> parser = __webpack_require__(<span class="hljs-number">9</span>);
	<span class="hljs-keyword">var</span> parseuri = __webpack_require__(<span class="hljs-number">31</span>);
	<span class="hljs-keyword">var</span> parsejson = __webpack_require__(<span class="hljs-number">32</span>);
	<span class="hljs-keyword">var</span> parseqs = __webpack_require__(<span class="hljs-number">20</span>);
...
<p>SSL options for Node.js client</p>
	  ...
	  <span class="hljs-keyword">this</span>.rejectUnauthorized = opts.rejectUnauthorized === <span class="hljs-literal">undefined</span> ? <span class="hljs-literal">null</span> : opts.rejectUnauthorized;
...
<div class="body">
	...
	Socket.Transport = __webpack_require__(<span class="hljs-number">8</span>);
	Socket.transports = __webpack_require__(<span class="hljs-number">3</span>);
	Socket.parser = __webpack_require__(<span class="hljs-number">9</span>);
...
<p>session id if we already have one</p>
	  ...
	  <span class="hljs-keyword">var</span> transport = <span class="hljs-keyword">new</span> transports[name]({
	    ...
	    <span class="hljs-attr">hostname</span>: <span class="hljs-keyword">this</span>.hostname,
	    <span class="hljs-attr">port</span>: <span class="hljs-keyword">this</span>.port,
	    <span class="hljs-attr">secure</span>: <span class="hljs-keyword">this</span>.secure,
	    <span class="hljs-attr">path</span>: <span class="hljs-keyword">this</span>.path,
	    <span class="hljs-attr">query</span>: query,
	    <span class="hljs-attr">forceJSONP</span>: <span class="hljs-keyword">this</span>.forceJSONP,
	    <span class="hljs-attr">jsonp</span>: <span class="hljs-keyword">this</span>.jsonp,
	    <span class="hljs-attr">forceBase64</span>: <span class="hljs-keyword">this</span>.forceBase64,
	    <span class="hljs-attr">enablesXDR</span>: <span class="hljs-keyword">this</span>.enablesXDR,
	    <span class="hljs-attr">timestampRequests</span>: <span class="hljs-keyword">this</span>.timestampRequests,
	    <span class="hljs-attr">timestampParam</span>: <span class="hljs-keyword">this</span>.timestampParam,
	    <span class="hljs-attr">policyPort</span>: <span class="hljs-keyword">this</span>.policyPort,
	    <span class="hljs-attr">socket</span>: <span class="hljs-keyword">this</span>,
	    <span class="hljs-attr">pfx</span>: <span class="hljs-keyword">this</span>.pfx,
	    <span class="hljs-attr">key</span>: <span class="hljs-keyword">this</span>.key,
	    <span class="hljs-attr">passphrase</span>: <span class="hljs-keyword">this</span>.passphrase,
	    <span class="hljs-attr">cert</span>: <span class="hljs-keyword">this</span>.cert,
	    <span class="hljs-attr">ca</span>: <span class="hljs-keyword">this</span>.ca,
	    <span class="hljs-attr">ciphers</span>: <span class="hljs-keyword">this</span>.ciphers,
	    <span class="hljs-attr">rejectUnauthorized</span>: <span class="hljs-keyword">this</span>.rejectUnauthorized,
	    <span class="hljs-attr">perMessageDeflate</span>: <span class="hljs-keyword">this</span>.perMessageDeflate,
	    <span class="hljs-attr">extraHeaders</span>: <span class="hljs-keyword">this</span>.extraHeaders,
	    <span class="hljs-attr">forceNode</span>: <span class="hljs-keyword">this</span>.forceNode,
	    <span class="hljs-attr">localAddress</span>: <span class="hljs-keyword">this</span>.localAddress
	  });
...
<p>Socket is live - any packet counts</p>
	    ...
	    <span class="hljs-keyword">switch</span> (packet.type) {
	      <span class="hljs-keyword">case</span> <span class="hljs-string">'open'</span>:
	        <span class="hljs-keyword">this</span>.onHandshake(parsejson(packet.data));
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">var</span> XMLHttpRequest = __webpack_require__(<span class="hljs-number">4</span>);
	<span class="hljs-keyword">var</span> XHR = __webpack_require__(<span class="hljs-number">6</span>);
	<span class="hljs-keyword">var</span> JSONP = __webpack_require__(<span class="hljs-number">27</span>);
	<span class="hljs-keyword">var</span> websocket = __webpack_require__(<span class="hljs-number">28</span>);
...
<p>browser shim for xmlhttprequest module</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">var</span> hasCORS = __webpack_require__(<span class="hljs-number">5</span>);
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">var</span> XMLHttpRequest = __webpack_require__(<span class="hljs-number">4</span>);
	<span class="hljs-keyword">var</span> Polling = __webpack_require__(<span class="hljs-number">7</span>);
	<span class="hljs-keyword">var</span> Emitter = __webpack_require__(<span class="hljs-number">19</span>);
	<span class="hljs-keyword">var</span> inherit = __webpack_require__(<span class="hljs-number">21</span>);
	<span class="hljs-keyword">var</span> debug = __webpack_require__(<span class="hljs-number">23</span>)(<span class="hljs-string">'engine.io-client:polling-xhr'</span>);
	  ...
	  <span class="hljs-keyword">try</span> {
	    ...
	    <span class="hljs-keyword">try</span> {
	      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.extraHeaders) {
	        xhr.setDisableHeaderCheck(<span class="hljs-literal">true</span>);
...
<p>This has to be done after open because Firefox is stupid
http://stackoverflow.com/questions/13216903/get-binary-data-with-xmlhttprequest-in-a-firefox-extension</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">	      xhr.responseType = <span class="hljs-string">'arraybuffer'</span>;
	    }
...
<span class="dox_type">private</span>
	...
	Request.prototype.onLoad = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
	  ...
	  <span class="hljs-keyword">try</span> {
	    ...
	    <span class="hljs-keyword">try</span> {
	      contentType = <span class="hljs-keyword">this</span>.xhr.getResponseHeader(<span class="hljs-string">'Content-Type'</span>).split(<span class="hljs-string">';'</span>)[<span class="hljs-number">0</span>];
	    } <span class="hljs-keyword">catch</span> (e) {}
	    <span class="hljs-keyword">if</span> (contentType === <span class="hljs-string">'application/octet-stream'</span>) {
	      ...
	      <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.supportsBinary) {
	        ...
	        <span class="hljs-keyword">try</span> {
	          ...
	          <span class="hljs-keyword">var</span> ui8Arr = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Uint8Array</span>(<span class="hljs-keyword">this</span>.xhr.response);
	          <span class="hljs-keyword">var</span> dataArray = [];
	          <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> idx = <span class="hljs-number">0</span>, length = ui8Arr.length; idx &lt; length; idx++) {
	            dataArray.push(ui8Arr[idx]);
	          }

	          data = <span class="hljs-built_in">String</span>.fromCharCode.apply(<span class="hljs-literal">null</span>, dataArray);
	        }
	      }
	    }
	  } <span class="hljs-keyword">catch</span> (e) {
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">var</span> Transport = __webpack_require__(<span class="hljs-number">8</span>);
	<span class="hljs-keyword">var</span> parseqs = __webpack_require__(<span class="hljs-number">20</span>);
	<span class="hljs-keyword">var</span> parser = __webpack_require__(<span class="hljs-number">9</span>);
	<span class="hljs-keyword">var</span> inherit = __webpack_require__(<span class="hljs-number">21</span>);
	<span class="hljs-keyword">var</span> yeast = __webpack_require__(<span class="hljs-number">22</span>);
	<span class="hljs-keyword">var</span> debug = __webpack_require__(<span class="hljs-number">23</span>)(<span class="hljs-string">'engine.io-client:polling'</span>);
...
<span class="hljs-comment">/***/</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">module, exports, __webpack_require__</span>) </span>{
	...
	<span class="hljs-keyword">var</span> keys = __webpack_require__(<span class="hljs-number">10</span>);
	<span class="hljs-keyword">var</span> hasBinary = __webpack_require__(<span class="hljs-number">11</span>);
	<span class="hljs-keyword">var</span> sliceBuffer = __webpack_require__(<span class="hljs-number">13</span>);
	<span class="hljs-keyword">var</span> after = __webpack_require__(<span class="hljs-number">14</span>);
	<span class="hljs-keyword">var</span> utf8 = __webpack_require__(<span class="hljs-number">15</span>);

	<span class="hljs-keyword">var</span> base64encoder;
	<span class="hljs-keyword">if</span> (global &amp;&amp; global.ArrayBuffer) {
	  base64encoder = __webpack_require__(<span class="hljs-number">17</span>);
	}
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">var</span> Blob = __webpack_require__(<span class="hljs-number">18</span>);
...
<span class="dox_type">private</span>
	...
	exports.encodePacket = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">packet, supportsBinary, utf8encode, callback</span>) </span>{
	  <span class="hljs-keyword">if</span> (<span class="hljs-string">'function'</span> == <span class="hljs-keyword">typeof</span> supportsBinary) {
	    callback = supportsBinary;
	    supportsBinary = <span class="hljs-literal">false</span>;
	  }

	  <span class="hljs-keyword">if</span> (<span class="hljs-string">'function'</span> == <span class="hljs-keyword">typeof</span> utf8encode) {
	    callback = utf8encode;
...
<p>data fragment is optional</p>
	    ...
	    encoded += utf8encode ? utf8.encode(<span class="hljs-built_in">String</span>(packet.data)) : <span class="hljs-built_in">String</span>(packet.data);
	  }
...
<span class="dox_type">private</span>
	...
	exports.encodePayload = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">packets, supportsBinary, callback</span>) </span>{
	  ...
	  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">encodeOne</span>(<span class="hljs-params">packet, doneCallback</span>) </span>{
	    exports.encodePacket(packet, !isBinary ? <span class="hljs-literal">false</span> : supportsBinary, <span class="hljs-literal">true</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">message</span>) </span>{
...
<p>parser error - ignoring payload</p>
	  ...
	  <span class="hljs-keyword">var</span> length = <span class="hljs-string">''</span>
	    , n, msg;
	  ...
	  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, l = data.length; i &lt; l; i++) {
	    ...
	    <span class="hljs-keyword">if</span> (<span class="hljs-string">':'</span> != chr) {
	      length += chr;
	    } <span class="hljs-keyword">else</span> {
	      <span class="hljs-keyword">if</span> (<span class="hljs-string">''</span> == length || (length != (n = <span class="hljs-built_in">Number</span>(length)))) {
</pre>
        </td>
      </tr>
...
<p>parser error - ignoring payload</p>
        ...
        <td class="code highlight">
	      ...
	      <span class="hljs-keyword">if</span> (msg.length) {
	        packet = exports.decodePacket(msg, binaryType, <span class="hljs-literal">true</span>);
...
<span class="dox_type">public</span>
	...
	exports.decodePayloadAsBinary = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">data, binaryType, callback</span>) </span>{
	  ...
	  <span class="hljs-keyword">var</span> numberTooLong = <span class="hljs-literal">false</span>;
	  <span class="hljs-keyword">while</span> (bufferTail.byteLength &gt; <span class="hljs-number">0</span>) {
	    ...
	    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">1</span>; ; i++) {
	      ...
	      <span class="hljs-keyword">if</span> (msgLength.length &gt; <span class="hljs-number">310</span>) {
	        numberTooLong = <span class="hljs-literal">true</span>;
	        <span class="hljs-keyword">break</span>;
	      }
	    ...
	    <span class="hljs-keyword">if</span>(numberTooLong) <span class="hljs-keyword">return</span> callback(err, <span class="hljs-number">0</span>, <span class="hljs-number">1</span>);
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">var</span> isArray = __webpack_require__(<span class="hljs-number">12</span>);
...
<div class="body">
<p>Right now only Buffer and ArrayBuffer are supported..</p>
</div>
<div class="details">
<div class="dox_tag_title">Params</div>
<div class="dox_tag_detail">
...
<span class="dox_type">public</span>
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">hasBinary</span>(<span class="hljs-params">data</span>) </span>{

	  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">_hasBinary</span>(<span class="hljs-params">obj</span>) </span>{
	    <span class="hljs-keyword">if</span> (!obj) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;

	    <span class="hljs-keyword">if</span> ( (global.Buffer &amp;&amp; global.Buffer.isBuffer(obj)) ||
	         (global.ArrayBuffer &amp;&amp; obj <span class="hljs-keyword">instanceof</span> <span class="hljs-built_in">ArrayBuffer</span>) ||
	         (global.Blob &amp;&amp; obj <span class="hljs-keyword">instanceof</span> Blob) ||
	         (global.File &amp;&amp; obj <span class="hljs-keyword">instanceof</span> File)
	        ) {
	    ...
	    <span class="hljs-keyword">if</span> (isArray(obj)) {
	      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; obj.length; i++) {
	          <span class="hljs-keyword">if</span> (_hasBinary(obj[i])) {
	              <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
	          }
	      }
	    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (obj &amp;&amp; <span class="hljs-string">'object'</span> == <span class="hljs-keyword">typeof</span> obj) {
	      <span class="hljs-keyword">if</span> (obj.toJSON) {
	        obj = obj.toJSON();
	      }

	      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> key <span class="hljs-keyword">in</span> obj) {
	        <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Object</span>.prototype.hasOwnProperty.call(obj, key) &amp;&amp; _hasBinary(obj[key])) {
	          <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;
	        }
	      }
	    }
	  ...
	  <span class="hljs-keyword">return</span> _hasBinary(data);
	}
...
<span class="hljs-comment">/***/</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">module, exports, __webpack_require__</span>) </span>{
	...
	<span class="hljs-keyword">var</span> __WEBPACK_AMD_DEFINE_RESULT__;<span class="hljs-comment">/* WEBPACK VAR INJECTION */</span>(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">module, global</span>) </span>{<span class="hljs-comment">/*! https://mths.be/wtf8 v1.0.0 by @mathias */</span>
...
<p>Taken from https://mths.be/punycode</p>
		...
		<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">encodeCodePoint</span>(<span class="hljs-params">codePoint</span>) </span>{
		...
		<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">wtf8encode</span>(<span class="hljs-params">string</span>) </span>{
...
<p>If we end up here, it’s not a continuation byte.</p>
		...
		<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">decodeSymbol</span>(<span class="hljs-params"></span>) </span>{
...
<p>2-byte sequence</p>
        ...
        <td class="code highlight">
          <pre class="javascript">			<span class="hljs-keyword">if</span> ((byte1 &amp; <span class="hljs-number">0xE0</span>) == <span class="hljs-number">0xC0</span>) {
				<span class="hljs-keyword">var</span> byte2 = readContinuationByte();
...
<p>4-byte sequence</p>
        ...
        <td class="code highlight">
          <pre class="javascript">			<span class="hljs-keyword">if</span> ((byte1 &amp; <span class="hljs-number">0xF8</span>) == <span class="hljs-number">0xF0</span>) {
				...
				codePoint = ((byte1 &amp; <span class="hljs-number">0x0F</span>) &lt;&lt; <span class="hljs-number">0x12</span>) | (byte2 &lt;&lt; <span class="hljs-number">0x0C</span>) |
			...
			<span class="hljs-keyword">throw</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'Invalid WTF-8 detected'</span>);
		}
		...
		<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">wtf8decode</span>(<span class="hljs-params">byteString</span>) </span>{
			byteArray = ucs2decode(byteString);
			byteCount = byteArray.length;
			byteIndex = <span class="hljs-number">0</span>;
			<span class="hljs-keyword">var</span> codePoints = [];
			<span class="hljs-keyword">var</span> tmp;
			<span class="hljs-keyword">while</span> ((tmp = decodeSymbol()) !== <span class="hljs-literal">false</span>) {
				codePoints.push(tmp);
			}
		...
		<span class="hljs-keyword">var</span> wtf8 = {
			<span class="hljs-string">'version'</span>: <span class="hljs-string">'1.0.0'</span>,
			<span class="hljs-string">'encode'</span>: wtf8encode,
			<span class="hljs-string">'decode'</span>: wtf8decode
		};
...
like the following:</p>
        ...
        <td class="code highlight">
          <pre class="javascript">		<span class="hljs-keyword">if</span> (
			...
			!(__WEBPACK_AMD_DEFINE_RESULT__ = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
				<span class="hljs-keyword">return</span> wtf8;
			...
			<span class="hljs-keyword">if</span> (freeModule) { <span class="hljs-comment">// in Node.js or RingoJS v0.8.0+</span>
				...
				<span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> key <span class="hljs-keyword">in</span> wtf8) {
	...
	<span class="hljs-comment">/* WEBPACK VAR INJECTION */</span>}.call(exports, __webpack_require__(<span class="hljs-number">16</span>)(<span class="hljs-built_in">module</span>), (<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }())))
...
<span class="hljs-comment">/***/</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">module, exports, __webpack_require__</span>) </span>{
	...
	<span class="hljs-comment">/* WEBPACK VAR INJECTION */</span>(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">process</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>Expose <code>debug()</code> as the module.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
	exports = <span class="hljs-built_in">module</span>.exports = __webpack_require__(<span class="hljs-number">25</span>);
	exports.log = log;
...
<span class="dox_type">private</span>
	...
	<span class="hljs-comment">/* WEBPACK VAR INJECTION */</span>}.call(exports, __webpack_require__(<span class="hljs-number">24</span>)))
...
<p>Expose <code>debug()</code> as the module.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
	exports = <span class="hljs-built_in">module</span>.exports = debug.debug = debug;
	exports.coerce = coerce;
	exports.disable = disable;
	exports.enable = enable;
	exports.enabled = enabled;
	exports.humanize = __webpack_require__(<span class="hljs-number">26</span>);
...
<p>apply env-specific formatting</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">	    args = exports.formatArgs.apply(self, args);
...
<span class="dox_type">public</span>
	...
	<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">enable</span>(<span class="hljs-params">namespaces</span>) </span>{
	  ...
	  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; len; i++) {
	    ...
	    namespaces = split[i].replace(<span class="hljs-regexp">/[\\^$+?.()|[\]{}]/g</span>, <span class="hljs-string">'\\$&amp;'</span>).replace(<span class="hljs-regexp">/\*/g</span>, <span class="hljs-string">'.*?'</span>);
...
<div class="body">
	...
	<span class="hljs-keyword">var</span> inherit = __webpack_require__(<span class="hljs-number">21</span>);
	<span class="hljs-keyword">var</span> yeast = __webpack_require__(<span class="hljs-number">22</span>);
	<span class="hljs-keyword">var</span> debug = __webpack_require__(<span class="hljs-number">23</span>)(<span class="hljs-string">'engine.io-client:websocket'</span>);
	...
	<span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">window</span> === <span class="hljs-string">'undefined'</span>) {
	  <span class="hljs-keyword">try</span> {
	    NodeWebSocket = __webpack_require__(<span class="hljs-number">29</span>);
	  } <span class="hljs-keyword">catch</span> (e) {}
	}
...
<p>let probe timeout</p>
	  ...
	  <span class="hljs-keyword">var</span> protocols = <span class="hljs-keyword">void</span> <span class="hljs-number">0</span>;
...
<p>SSL options for Node.js client</p>
	  ...
	  <span class="hljs-keyword">try</span> {
	    <span class="hljs-keyword">this</span>.ws = <span class="hljs-keyword">this</span>.usingBrowserWebSocket ? <span class="hljs-keyword">new</span> WebSocket(uri) : <span class="hljs-keyword">new</span> WebSocket(uri, protocols, opts);
	  } <span class="hljs-keyword">catch</span> (err) {
...
<span class="hljs-comment">/***/</span> <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">module, exports</span>) </span>{
	...
	<span class="hljs-keyword">var</span> rvalidchars = <span class="hljs-regexp">/^[\],:{}\s]*$/</span>;
	<span class="hljs-keyword">var</span> rvalidescape = <span class="hljs-regexp">/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g</span>;
	<span class="hljs-keyword">var</span> rvalidtokens = <span class="hljs-regexp">/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g</span>;
	<span class="hljs-keyword">var</span> rvalidbraces = <span class="hljs-regexp">/(?:^|:|,)(?:\s*\[)+/g</span>;
	<span class="hljs-keyword">var</span> rtrimLeft = <span class="hljs-regexp">/^\s+/</span>;
	<span class="hljs-keyword">var</span> rtrimRight = <span class="hljs-regexp">/\s+$/</span>;

	<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parsejson</span>(<span class="hljs-params">data</span>) </span>{
	  <span class="hljs-keyword">if</span> (<span class="hljs-string">'string'</span> != <span class="hljs-keyword">typeof</span> data || !data) {
	    <span class="hljs-keyword">return</span> <span class="hljs-literal">null</span>;
	  }

	  data = data.replace(rtrimLeft, <span class="hljs-string">''</span>).replace(rtrimRight, <span class="hljs-string">''</span>);
...
<p>Attempt to parse using the native JSON parser first</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	  <span class="hljs-keyword">if</span> (global.JSON &amp;&amp; <span class="hljs-built_in">JSON</span>.parse) {
